...
export const AR: Bundle = {
  ...
  // ---- import / export ----
  importTitle: `استيراد ملفات أو ملف ${ZIP}`,
  importIntro: `أدخِل ملفات مفردة، أو مجلّدًا كاملًا، أو ملف ${ZIP} صدّرته من ورشة — كل شيء يبقى على جهازك.`,
  importDropHint: `أفلت ملفات أو مجلّدًا أو ملف ${ZIP} هنا، أو`,
  importReplaces: (n) => `سيحلّ هذا محلّ ${files(n)} لديك الآن. صدّر ملف ${ZIP} أولًا إن أردت الاحتفاظ بعملك.`,
  importEmpty: 'لا شيء للاستيراد — لا ملفات نصية فيما اخترته. حاول مرة أخرى.',
  importUnreadable: (detail) => `تعذّر فتحه. (${iso(detail)})`,
  ...
  importChooseFiles: 'اختر ملفات',
  importChooseFolder: 'اختر مجلّدًا',
  importDefaultName: 'ملفات مستوردة',
  ...
  extIndentGuidesDesc: 'يرسم خطًا رفيعًا عند كل مستوى إزاحة، ليبقى تراصف الكتل واضحًا أمامك وأنت تقرأ.',
  extIndentRainbowName: 'إزاحة ملوّنة',
  extIndentRainbowDesc: 'يصبغ كل مستوى إزاحة بلون يتناوب مع ما قبله، ويفيدك خاصةً مع الكود الكثير التداخل.',
  extFormatOnSaveName: 'التنسيق عند الحفظ',
  extFormatOnSaveDesc: 'يُعيد تنسيق الملف تلقائيًا كلما حفظت. وما لا يعرف تنسيقه بعد يتركه كما هو دون إزعاج.',
  extEnableLabel: (name: string) => `تفعيل ${name}`,
  ...
  noteFileDownloaded: (name) => `نُزّل ${iso(name)}.`,
  noteFileDownloadFailed: 'لم يُنزَّل هذا الملف.',
  ...
  menuAllProjects: 'كل المشاريع',
  menuImportZip: 'استيراد…',
  ...
  menuEditorTextSize: 'حجم خط المحرر',

  // ---- قائمة المشاركة ----
  // كل طريقة يخرج بها العمل من ورشة، بالكلمات نفسها أينما ظهرت. الصف يقول ماذا
  // ينتج، والعنوان فوقه يقول على أي شيء يعمل.
  menuShare: 'مشاركة',
  menuShareImage: 'مشاركة كصورة…',
  menuShareLink: 'مشاركة كرابط…',
  menuSharePdf: 'مشاركة كملف PDF…',
  menuDownloadFile: 'تنزيل الملف',
  menuGroupThisFile: 'هذا الملف',
  menuGroupThisProject: 'هذا المشروع',
  menuGroupLiveSession: 'الجلسة المباشرة',
  menuGroupAccount: 'الحساب',
  menuGroupSettings: 'الإعدادات',
  ...
  cmdFileShareImage: 'مشاركة: الملف كصورة…',
  cmdFileDownload: 'مشاركة: تنزيل الملف',
  cmdFileImport: 'ملف: استيراد…',
  ...
  cmdProjectsExport: `مشاركة: المشروع كملف ${ZIP}`,
  cmdProjectsShareLink: 'مشاركة: المشروع كرابط…',
  cmdProjectsSharePdf: 'مشاركة: المشروع كملف PDF…',
  ...
  // ---- التعاون المباشر (collab/) ----
  collabStart: 'بدء جلسة مباشرة',
  collabStop: 'إنهاء الجلسة المباشرة',
  collabLive: 'مباشر',
  collabStarted: 'الجلسة المباشرة مفعّلة، ورابط الدعوة في الحافظة.',
  collabStopped: 'انتهت الجلسة المباشرة.',
  collabStartFailed: 'تعذّر بدء الجلسة المباشرة.',
  collabJoined: (name: string) => `انضم ${name} إلى الجلسة.`,
  collabLeft: (name: string) => `غادر ${name} الجلسة.`,
  ...
  collabViewOnlyHint: 'شارك معك مالكُ الجلسة بصلاحية العرض فقط — التحرير معطّل.',
  ...
  authIntro: 'سجّل الدخول لرفع حدود المزامنة ومشاركة عملك عبر أجهزتك.',
  authEmailLabel: 'البريد الإلكتروني',
  authPasswordLabel: 'كلمة المرور',
  authPasswordHint: '٨ أحرف على الأقل.',
  authEmailInvalid: 'أدخل بريدًا إلكترونيًا صحيحًا.',
  authPasswordWeak: 'استخدم ٨ أحرف على الأقل.',
  authPasswordRequired: 'أدخل كلمة المرور.',
  authSignInAction: 'دخول',
  authSignUpAction: 'إنشاء الحساب',
  authWorking: 'جارٍ التنفيذ…',
  authSwitchToSignUp: 'جديد هنا؟ أنشئ حسابًا',
  authSwitchToSignIn: 'لديك حساب؟ سجّل الدخول',
  authErrorTaken: 'هذا البريد مسجّل من قبل — سجّل الدخول بدلًا من ذلك.',
  authErrorInvalid: 'البريد أو كلمة المرور غير صحيحة.',
  authErrorNetwork: 'تعذّر الوصول إلى الخادم. تحقّق من اتصالك وحاول مجددًا.',
  ...
  authUsageDocs: 'المشاريع',
  authUsageStorage: 'التخزين',

  // ---- مربّع المشاركة ----
  menuShareRoom: 'رابط الجلسة المباشرة…',
  shareTitle: 'شارك هذه الجلسة',
  shareIntro: 'اختر من يمكنه فتح رابط الدعوة.',
  shareLinkAccessLabel: 'صلاحية الرابط',
  shareLinkEditor: 'أي شخص لديه الرابط يمكنه التحرير',
  shareLinkEditorDesc: 'ينضمّ ويحرّر المشروع معك.',
  shareLinkViewer: 'أي شخص لديه الرابط يمكنه العرض',
  shareLinkViewerDesc: 'يتابع معك دون إجراء تغييرات.',
  shareLinkOff: 'إيقاف الرابط',
  shareLinkOffDesc: 'لا يمكن لأحد جديد الانضمام عبر الرابط.',
  shareCopyLink: 'نسخ الرابط',
  shareLinkCopied: 'نُسخ رابط الدعوة إلى الحافظة.',
  shareUpdated: 'حُدّثت صلاحية الرابط.',
  shareUpdateFailed: 'تعذّر تحديث صلاحية الرابط.',
  shareGuestNote: 'انسخ الرابط لدعوة الآخرين. مالك الجلسة وحده يمكنه تغيير من ينضمّ.',
  shareEmailTitle: 'دعوة أشخاص بالبريد الإلكتروني',
