...
export const AR: Bundle = {
  ...
  pickerImportHint: `ملفات، أو مجلّد، أو ملف ${ZIP} وصلك.`,
  ...
  collabStart: 'ابدأ التعاون',
  collabStop: 'إنهاء التعاون',
  collabLive: 'مباشر',
  collabStarted: 'التعاون مفعّل، ورابط الدعوة في الحافظة.',
  collabStopped: 'انتهى التعاون.',
  collabStartFailed: 'تعذّر بدء التعاون.',
