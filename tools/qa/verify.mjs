 ...
 *
 * Drives LOCAL Google Chrome against http://localhost:8086 (a secure context, so
...
let navigations = 0
page.on('framenavigated', (f) => { if (f === page.mainFrame() && f.url().startsWith(URL_)) navigations++ })
